...
function VerifyCancelAppointment({mobile, showResendSMS, id}) {
    ...
    const submit = (e) => {
        e.preventDefault();
        if (check())
            post(route('verify-cancel-appointment', id));
    };
    const check = () => {
        clearErrors()
        let output = true;
...
VerifyCancelAppointment.layout = (page) => <Layout children={page}/>

export default VerifyCancelAppointment;
